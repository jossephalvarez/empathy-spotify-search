...
const actions = {
    ...
    async getAlbums({dispatch, state: {albums, query}}) {
    ...
    async getArtists({dispatch, state: {artists, query}}) {
    ...
    async getPlaylists({dispatch, state: {playlists, query}}) {
    ...
    async getTracks({dispatch, state: {tracks, query}}) {
